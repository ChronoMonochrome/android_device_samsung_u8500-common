...
ARM_CROSS_COMPILE := CROSS_COMPILE="/home/chronomonochrome/root/prebuilts/misc/linux-x86/ccache/ccache /home/chronomonochrome/root/prebuilts/gcc/linux-x86/arm/armv7a-linux-gnueabihf-5.2/bin/armv7a-linux-gnueabihf-"
...
RECOVERY_RAMDISK := device/samsung/u8500-common/prebuilt/ramdisk-recovery.cpio

TARGET_KERNEL_BINARIES: $(KERNEL_OUT) $(KERNEL_CONFIG) $(KERNEL_HEADERS_INSTALL) $(RECOVERY_RAMDISK) $(uncompressed_ramdisk)
